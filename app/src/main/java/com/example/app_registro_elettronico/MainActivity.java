        ...
        try {
            ...
            for (String tmp : genitoriSplit) {
                ...
                if (temp_split.length > 1) {
                    ...
                    for (Studente st : getStudentiServer()) {
                    ...
                    Genitore genitore = new Genitore(nome, cognome, data, cf, figlio);
                    genitore.setCredenziali(new Credenziali(username, password));
